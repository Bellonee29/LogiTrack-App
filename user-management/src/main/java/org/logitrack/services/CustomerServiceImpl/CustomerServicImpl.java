...
public class CustomerServicImpl implements CustomerService {
    ...
    @Override
    public ApiResponse registerDeliveryMan(DeliveryManCreatingRequest request) {
    ...
    @Override
    public LoginResponse login(AppUserLoginRequest loginDTO) {
            ...
            return Stream.of(
                    ...
                    .collect(
                            Collectors.collectingAndThen(
                                    ...
                                    map -> new LoginResponse((Map<String, String>) map)
                            )
                    );
        ...
        String tokenGenerated = "Bearer " + jwtService.generateToken(authenticationUser,appUser.getRole());
        ...
        LoginResponse apiResponse = new LoginResponse("00", "Success", loginResponse, "Successfully logged in", HttpStatus.OK);
